<x-dashboard-layout>
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
                <h2 class="text-2xl font-black text-[hsl(var(--hospital-header))] tracking-tight">Specialist <span
                        class="text-[hsl(var(--hospital-primary))]">Directory</span></h2>
                <p class="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-[0.2em]">Medical Staff Management
                    Hub</p>
            </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                    ...
                    <tr class="bg-white">
                        <th class="px-5 py-6">
                            <button
                                ...
                                <span
                                    class="text-[10px] font-black text-slate-400 group-hover:text-slate-900 uppercase tracking-[0.2em]">Medical
                                    Expert</span>
                        ...
                        <th class="px-5 py-6">
                            <button
                                class="w-full flex items-center justify-between px-5 py-3 rounded-2xl bg-slate-50/50 border border-transparent hover:border-slate-100 hover:bg-white transition-all duration-300 group">
                                <span
                                    class="text-[10px] font-black text-slate-400 group-hover:text-slate-900 uppercase tracking-[0.2em]">Department</span>
                                <svg class="w-3.5 h-3.5 text-slate-300 group-hover:text-[hsl(var(--hospital-primary))] transition-colors"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                                        d="M8 9l4-4 4 4m0 6l-4 4-4-4"></path>
                        ...
                        <th class="px-5 py-6">
                            <button
                                class="w-full flex items-center justify-between px-5 py-3 rounded-2xl bg-slate-50/50 border border-transparent hover:border-slate-100 hover:bg-white transition-all duration-300 group">
                                <span
                                    class="text-[10px] font-black text-slate-400 group-hover:text-slate-900 uppercase tracking-[0.2em]">Clinical
                                    Exp.</span>
                                <svg class="w-3.5 h-3.5 text-slate-300 group-hover:text-[hsl(var(--hospital-primary))] transition-colors"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                        ...
                        <th class="px-5 py-6">
                            <button
                                class="w-full flex items-center justify-between px-5 py-3 rounded-2xl bg-slate-50/50 border border-transparent hover:border-slate-100 hover:bg-white transition-all duration-300 group">
                                <span
                                    class="text-[10px] font-black text-slate-400 group-hover:text-slate-900 uppercase tracking-[0.2em]">Consult.
                                    Fee</span>
                                <svg class="w-3.5 h-3.5 text-slate-300 group-hover:text-[hsl(var(--hospital-primary))] transition-colors"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                ...
                <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-slate-50/50 transition-all duration-300 group">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-slate-400 text-[10px] mt-1 font-medium">
                                            {{ $doctor->user?->email ?? 'No Email' }}</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-10 py-7">
                                <span
                                    class="inline-flex items-center px-4 py-1.5 rounded-full bg-teal-50 text-teal-600 text-[10px] font-black uppercase tracking-[0.15em] ring-1 ring-teal-100 shadow-sm">
                            ...
                            <td class="px-10 py-7">
                                <div class="flex items-center gap-2">
                                    <span
                                        class="text-slate-900 font-black text-base tracking-tight">{{ $doctor->experience }}</span>
                                    <span
                                        class="text-slate-400 text-[11px] font-bold uppercase tracking-widest">Years</span>
                                </div>
                            </td>
                            <td class="px-10 py-7">
                                <span class="font-black text-slate-900 text-base tracking-tighter">
                            ...
                            <td class="px-10 py-7 text-right">
                                <div class="flex items-center justify-end gap-3">
                                    ...
                                    <form action="/admin/doctors/{{ $doctor->id }}/delete" method="POST"
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-10 py-32 text-center text-slate-400 italic">
                                <div class="flex flex-col items-center gap-4">
                                    ...
                                    <p class="text-slate-400 font-black text-[11px] uppercase tracking-[0.3em]">No
                                        Specialists Found</p>
                                </div>
                            </td>
                        </tr>
