        ...
        <form action="{{ route('admin.departments.store') }}" method="POST"
            ...
            <div class="space-y-12">
                <div class="border-b border-slate-50 pb-8">
                    ...
                    <p class="text-sm font-bold text-slate-400 mt-1 uppercase tracking-widest">Define the department details</p>
                </div>
            ...
            <div class="flex flex-col md:flex-row items-center justify-between gap-8 pt-12 border-t border-slate-50">
                <a href="{{ route('admin.departments.index') }}"
                    class="text-sm font-black text-slate-400 hover:text-slate-600 uppercase tracking-widest transition-all">Discard</a>
                <button type="submit"
